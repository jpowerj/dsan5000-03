...
## Authentication via `PyGithub` {.smaller .shift-footnotes}
...
{{< embed github-auth.ipynb#pygithub-noauth >}}
...
{{< embed github-auth.ipynb#pygithub-auth >}}
...
[Wikipedia API Demo Link <i class="bi bi-box-arrow-up-right ps-1"></i>](https://jfh.georgetown.domains/dsan5000/slides-and-labs/_site/content/labs/code-demos/API-wikipedia/wikipedia-api.html){target="_blank"}

## Google Scholar API

[Google Scholar API Demo Link <i class="bi bi-box-arrow-up-right ps-1"></i>](https://jfh.georgetown.domains/dsan5000/slides-and-labs/_site/content/labs/code-demos/API-google-scholar/google-scholar-api.html){target="_blank"}

## News API

[News API Lab Demo Link <i class="bi bi-box-arrow-up-right ps-1"></i>](https://jfh.georgetown.domains/dsan5000/slides-and-labs/_site/content/labs/code-demos/API-newapi/news-api.html){target="_blank"}

## Lab Assignment Overview

[Lab 2.1 <i class="bi bi-box-arrow-up-right ps-1"></i>](https://jfh.georgetown.domains/dsan5000/slides-and-labs/_site/content/labs/assignments/lab-2.1/lab-2.1.html){target="_blank"}
